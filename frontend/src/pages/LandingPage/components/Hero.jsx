...
const Hero = () => {
  ...
  const user = { fullName: "Анатолий", role: "employer" };
  const navigate = useNavigate();

  const stats = [
    { icon: Users, label: "Активные пользователи", value: "2.4M+" },
    { icon: Building2, label: "Компании", value: "50K+" },
    { icon: TrendingUp, label: "Вакансий", value: "150K+" },
  ];
  ...
  return (
    <section className="pt-24 pb-16 bg-white min-h-screen flex items-center">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight md:leading-16 lg:leading-20 pt-10"
          >
            Найди работу мечты или{" "}
          ...
          >
            Пока вы читаете данный текст, сотни компаний ищут специалиста.
            Возможно, именно вас. Здесь собраны лучшие предложения с рынка. Ваше
            следующее резюме может стать последним, которое вам понадобится
            отправить.
          </motion.p>
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="flex flex-col items-center space-y-2 py-4 rounded-xl hover:bg-gray-50 transition-colors"
              >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none ">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-purple-100 rounded-full blur-3xl opacity-30"></div>
