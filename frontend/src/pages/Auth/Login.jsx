      ...
      setFormState((prev) => ({
        ...
        errors: {
          submit:
            ...
            "Не удалось авторизоваться. Проверьте введенные данные.",
        },
      }));
    }
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">Вы успешно авторизовались.</p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Зайдите в ваш аккаунт</p>
        </div>
